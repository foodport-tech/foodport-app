...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  Widget _buildTab(int index, String iconLocation, String? title) {
    return Expanded(
      child: InkWell(
        onTap: () {
          setState(() {
        ...
        child: Column(
          children: <Widget>[
            ...
            Image.asset(
              ...
              width: 20,
              height: 20,
              color: _selectedIndex == index ? primaryColor : neutral4Color,
            ),
            title != null
                ? Text(
                    title,
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  _buildTab(0, "assets/images/icons/grid.png", null),
                  _buildTab(1, "assets/images/icons/bookmark.png", null),
                  _buildTab(2, "assets/images/icons/love.png", null),
                ],
              ),
            ),

            // SECTION 4: Post Pages
